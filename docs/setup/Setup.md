...
- Colocar en `data/input/` los CSV de índice: `town_index.csv` y `new_town_index.csv` (o configurar paths por env).
- El resto de archivos (datos_tiempo.csv, output.csv, map.html, etc.) se generan en `data/output/`. Ver [data/README.md](../../data/README.md).
...
| `TOWN_INDEX_PATH` | Ruta del índice de localidades (script clásico) | `data/input/town_index.csv` |
| `NEW_TOWN_INDEX_PATH` | Ruta del índice alternativo | `data/input/new_town_index.csv` |
| `DATOS_TIEMPO_PATH` | CSV de extremos (frío/calor) | `data/output/datos_tiempo.csv` |
| `MAP_PATH` | Mapa Folium generado | `data/output/map.html` |
| `OUTPUT_CSV_PATH` | CSV merge completo | `data/output/output.csv` |
| `NGINX_INDEX_PATH` | Mapa para nginx | `data/output/index.nginx-debian.html` |
| `WEATHER_DATA_PATH` | CSV auxiliar de tiempo | `data/output/weather_data.csv` |
